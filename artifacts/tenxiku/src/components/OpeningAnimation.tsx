    ...
    <AnimatePresence>
      {phase !== "done" && (
        <motion.div
          ...
          transition={{ duration: phase === "out" ? 0.9 : 0, ease: [0.7, 0, 0.3, 1] }}
        ...
        >
            ...
            {PETALS.map((p) => (
              ...
              >
                <svg viewBox="0 0 20 14" fill="none" className="w-full h-full">
                  <ellipse cx="10" cy="7" rx="9" ry="5.5" fill="rgba(255,220,230,0.75)" />
                  <line x1="10" y1="1" x2="10" y2="13" stroke="rgba(255,180,200,0.4)" strokeWidth="0.5" />
                </svg>
              </motion.div>
            ))}
          </div>
          ...
          <motion.div
            ...
            animate={{ opacity: phase !== "in" ? 1 : 0, y: phase !== "in" ? 0 : 20 }}
